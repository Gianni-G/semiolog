...
class Type:
    ...
    def __init__(self,parad,semiotic) -> None:
        ...
        self.global_probs = np.array([semiotic.voc.prob.get(k,0) for k in parad.keys_t])
        ...
        self.global_probs_s = np.array([semiotic.voc.prob.get(k,0) for k in parad.keys_t_soft])
